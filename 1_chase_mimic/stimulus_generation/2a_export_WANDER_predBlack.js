...
import dataStr from "/Users/f0053cz/Documents/GitHub/chase_mimic_study/test_version/base_stim_wander_predBlack.psyn";
...
for (let var_j of posPredatorPreyVariations) {// LR or RL
  ...
  for (let var_k = 0; var_k < 6; var_k++) {// recollapses
    //let flname = "pred_Black_Pos" + pred_xpos.param[last_ind] + "_" + pred_xpos.val
    let flname = "pred_Black_Pos" + pred_xpos.param[last_ind] + "_" + pred_xpos.val + "_var" + var_k
    console.log(flname)
    let varGroup = {
      name: flname,
      variations: [
